    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/o-centro">O Centro</a></li>
                <li class="nav-item"><a class="nav-link" href="/actividades">Actividades</a></li>
                <li class="nav-item"><a class="nav-link" href="/corpo-docente">Corpo Docente</a></li>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @guest
                    @if(config('cdo.front_login'))
                        <li><a class="nav-link" href="{{ route('login') }}">{{ __('Entrar') }}</a></li>
                    @endif

                    @if(config('cdo.front_register'))
